            ...
            <header className='header'>
                <div className='header-container'>
                    ...
                    <div className='header-right-elements'>
                        ...
                        <button className='toggle-icon header-item tooltip-container' onClick={onSettings} style={{ color: "white", }}>
                            <span className="material-symbols-outlined header-google-icon-item" style={{fontSize: '22px'}}>
                                settings
                            </span>
                            <span className='simple-tooltip'> настройки </span>
                        </button>
                        <div className='menu-button multi-el-header-item header-item profile-nav tooltip-container' >
                            ...
                            <span className="material-symbols-outlined header-google-icon-item" style={{fontSize: '1.5rem'}}>
                                account_circle
                            </span>
